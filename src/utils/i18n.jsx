  ...
  resources: {
    en: {
      translation: {
        ...
        projects: "Projects",
        about_text:
          "I'm {{age}} years old. I completed my master's degree in IT at the Silesian University of Technology. I had my first IT experiences in high school. At first I learned C++, but I liked Kotlin and I developed in this area. Currently I'm improving my skills in Flutter/Dart and Python.",
        hobbies_text:
    ...
    pl: {
      translation: {
        ...
        about_text:
          "Mam {{age}} lat. Ukończyłem studia magisterskie z informatyki na Politechnice Śląskiej. Pierwsze kroki związane z informatyką podjąłem w liceum. Na początku uczyłem się C++, ale spodobał mi się Kotlin i zacząłem się w tym kierunku rozwijać. Obecnie doskonalę swoje umiejętności w technologii Flutter/Dart oraz Python.",
        hobbies_text:
